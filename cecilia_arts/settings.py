"""
Django settings for cecilia_arts project.
...
SECRET_KEY = 'ow9dbahv33xwaw0q6-d-i6(un$7#)pok4m3a=_xe^%hyje5e#2'
...
ROOT_URLCONF = 'cecilia_arts.urls'
...
WSGI_APPLICATION = 'cecilia_arts.wsgi.application'
